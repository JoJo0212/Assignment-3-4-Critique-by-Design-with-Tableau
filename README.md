...
After doing hand sketching, I tried to build it through Tableau.
...
To improve visibility, I adjusted the placement of data points on the line graph, particularly for years with closely grouped production numbers. This adjustment aims to ensure readers can readily identify and differentiate data points, addressing potential ambiguity. Moreover, I strategically marked key data points corresponding to the years mentioned in the article, providing a clear emphasis on significant trends. Additionally, I incorporated a succinct paragraph at the top of the chart, offering a summary of essential insights from the article. This concise overview serves as a helpful guide for readers eager to grasp the main points swiftly, facilitating a smoother transition into the detailed information presented in the graph.
